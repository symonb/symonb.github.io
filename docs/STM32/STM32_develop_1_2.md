...
[![image](images/1663152568459945-1.jpg)](images/1663152568459945-1.jpg)<custom_caption>Nucleo board has ST-Link programmer</custom_caption>

[![image](images/1663152573604436-0.jpg)](images/1663152573604436-0.jpg)<custom_caption>ST-Link dongle</custom_caption>
...
If everything works you can go further, if not repeat earlier steps [4th step - OpenOCD installation](#fourth_step).

Then, go into the bin folder in your CMake directory (*C:\tools\CMake\bin*), turn on the cmd window:
