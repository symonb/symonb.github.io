...
This implementation is called Direct Form 1 and works fine but the same result can be achieved by 3 other formulas ([more info here](https://en.wikipedia.org/wiki/Digital_biquad_filter#Direct_form_2)). Some of them are better for floating-point implementation some for fixed-point - in general, all is about increasing precision - rounding intermediate results and omitting overflow.
...
*    [link]() (filters design)
*    [link]() (biquad filters implementation)
*    [link]() (cookbook for 2nd order filters)
*    [link]() (notch filter - great explanation)*
